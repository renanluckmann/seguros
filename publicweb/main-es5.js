...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_li_95_mat_form_field_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_li_95_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AppComponent_li_95_Template_mat_checkbox_ngModelChange_1_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

          var subtask_r3 = ctx.$implicit;
          return subtask_r3.completed = $event;
        })("ngModelChange", function AppComponent_li_95_Template_mat_checkbox_ngModelChange_1_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);
          ...
          ctx_r9.updateAllComplete();
          return ctx_r9.abrir(subtask_r3);
        });
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(http) {
        ...
        this.task = {
          ...
          subtasks: [{
            ...
            name: 'Invalidez Perm. Total ou Parcial por Acidente',
            completed: false,
            color: 'primary'
          }, {
            name: 'Invalidez Permanente Total por Doença',
            completed: false,
            color: 'primary'
          }, {
            name: 'Despesas Médico-Hospitalares por Acidente',
            completed: false,
            color: 'primary'
          }, {
            name: 'Doenças Graves',
        ...
        this.checkoutForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
          nomeCompleto: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
          ...
          profissao: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
          ...
          celular: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
          email: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
          fumante: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
          esportesRadicais: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
          quaisEsportes: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](),
          participantes: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
          valores: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormArray"]([new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](), new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](), new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](), new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](), new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](), new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](), new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](), new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]()])
        });
      }
      ...
      _createClass(AppComponent, [{
        ...
        key: "onSubmit",
        value: function onSubmit(form1) {
          var _this = this;

          // console.log(form1);
          this.desejadas = [];
          this.task.subtasks.filter(function (t) {
            return t.completed;
          }).forEach(function (t) {
            return _this.desejadas.push(t.name);
          });
          form1.valores = form1.valores.filter(function (item) {
            return item != null && item != 0;
          });

          for (var index = 0; index < this.desejadas.length; index++) {
            this.desejadas[index] += " : " + form1.valores[index] + " \n\n                  ";
          }

          var email = "  Nome:        #NOME\n                   Nascimento:  #NASCIMENTO\n                   Sexo:        #SEXO\n                   Profiss\xE3o:   #PROFISSAO\n                   Cidade:      #CIDADE\n                   Bairro:      #BAIRRO\n                   Endereco:    #ENDERECO\n                   CEP:         #CEP\n                   Telefone:    #TELEFONE\n                   Celular:     #CELULAR\n                   Email:       #EMAIL\n                   Fumante?:    #FUMANTE\n                   Esportes Radicais: #ESPORTES\n                   Quais esportes?:   #QUAIS\n\n                   Participantes:     #PARTICIPANTES\n                   \n                   Coberturas/Valores:\n                   #COBERTURAS\n                   ";
          email = email.replace("#NOME", form1.nomeCompleto).replace("#NASCIMENTO", form1.dtNascimento).replace("#SEXO", form1.sexo).replace("#PROFISSAO", form1.profissao).replace("#CIDADE", form1.cidade).replace("#BAIRRO", form1.bairro).replace("#ENDERECO", form1.endereco).replace("#CEP", form1.CEP).replace("#TELEFONE", form1.telefone).replace("#CELULAR", form1.celular).replace("#EMAIL", form1.email).replace("#FUMANTE", form1.fumante).replace("#ESPORTES", form1.esportesRadicais).replace("#QUAIS", form1.quaisEsportes).replace("#PARTICIPANTES", form1.participantes).replace("#COBERTURAS", this.desejadas);
          var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'Content-Type': 'application/json'
          });
          this.http.post('https://formspree.io/moqkjyvo', {
            name: 'Seguradora',
            replyto: 'rluckmann94@gmail.com',
            message: email
          }, {
            'headers': headers
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](5, "Preencha os dados abaixo para fazer seu or\xE7amento! ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](25, "Profiss\xE3o");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](37, "Endere\xE7o");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](59, "\xC9 fumante?");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](64, "N\xE3o");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](72, "N\xE3o");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](75, "Se pratica, quais s\xE3o?");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function AppComponent_Template_mat_checkbox_change_91_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](100, " D\xFAvidas?\xA0 ");
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["NoopAnimationsModule"], _app_material_module__WEBPACK_IMPORTED_MODULE_4__["AngularMaterialModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"], ng_brazil__WEBPACK_IMPORTED_MODULE_7__["NgBrazil"], angular2_text_mask__WEBPACK_IMPORTED_MODULE_8__["TextMaskModule"], ng2_currency_mask__WEBPACK_IMPORTED_MODULE_9__["CurrencyMaskModule"]]]
    });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Trabalho\Seguros\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
